      ...
      {data.map((card, index) => {
        ...
        return (
          ...
          >
            ...
            {/* Raiting Div */}
            <div className="Rating absolute w-[3.5vw] h-[3.5vw] rounded-full flex justify-center items-center right-3 top-3 bg-gradient-to-r from-[#6556CD] to-pink-500 text-white shadow-lg text-sm font-semibold transform -translate-y-1/2 translate-x-1/2">
