          ...
          <div className="flex flex-col lg:flex-row lg:gap-10">
            ...
            <div className="lg:w-1/4 mb-10 lg:mb-0">
              ...
              <div className="text-white mt-5 space-y-2">
                ...
                <p>
                  <strong>Birthday:</strong> {info.detail.birthday}
                </p>
                <p>
                ...
                <p>
                  <strong>Place Of Birth:</strong> {info.detail.place_of_birth}
                </p>
                <p>
            ...
            <div className="lg:w-3/4 text-white">
              ...
              <div className="mb-5">
                ...
                <p className="text-zinc-400 mt-2 leading-relaxed max-h-40 overflow-y-auto">
